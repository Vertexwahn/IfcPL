...
IF EXIST C:\dev\IfcPL\examples\TrafficLight.ifcpl (set IFCPL_SOURCE_FILE=C:\dev\IfcPL\examples\TrafficLight.ifcpl)
IF EXIST E:\dev\IfcPL\examples\TrafficLight.ifcpl (set IFCPL_SOURCE_FILE=E:\dev\IfcPL\examples\TrafficLight.ifcpl)

IF EXIST C:\build\vs2017\x64\tmp\TrafficLight rd /s /q C:\build\vs2017\x64\tmp\TrafficLight
mkdir C:\build\vs2017\x64\tmp\TrafficLight
robocopy %IFCPL_FRAMEWORK% C:\build\vs2017\x64\tmp\TrafficLight
robocopy %IFCPL_FRAMEWORK%\CMake C:\build\vs2017\x64\tmp\TrafficLight\CMake
%TRANSPILER_PATH% %IFCPL_SOURCE_FILE% -o C:\build\vs2017\x64\tmp\TrafficLight
cmake -G"Visual Studio 15 2017 Win64" ^
-HC:\build\vs2017\x64\tmp\TrafficLight ^
-BC:\build\vs2017\x64\tmp\TrafficLight\build ^
...
C:
cd C:\build\vs2017\x64\tmp\TrafficLight\build
