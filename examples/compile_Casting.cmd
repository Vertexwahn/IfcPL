...
IF EXIST C:\dev\IfcPL\examples\Casting.ifcpl (set IFCPL_SOURCE_FILE=C:\dev\IfcPL\examples\Casting.ifcpl)
IF EXIST E:\dev\IfcPL\examples\Casting.ifcpl (set IFCPL_SOURCE_FILE=E:\dev\IfcPL\examples\Casting.ifcpl)

IF EXIST C:\build\vs2017\x64\tmp\Casting rd /s /q C:\build\vs2017\x64\tmp\Casting
mkdir C:\build\vs2017\x64\tmp\Casting
robocopy %IFCPL_FRAMEWORK% C:\build\vs2017\x64\tmp\Casting
robocopy %IFCPL_FRAMEWORK%\CMake C:\build\vs2017\x64\tmp\Casting\CMake
%TRANSPILER_PATH% %IFCPL_SOURCE_FILE% -o C:\build\vs2017\x64\tmp\Casting
cmake -G"Visual Studio 15 2017 Win64" ^
-HC:\build\vs2017\x64\tmp\Casting ^
-BC:\build\vs2017\x64\tmp\Casting\build ^
...
C:
cd C:\build\vs2017\x64\tmp\Casting\build
