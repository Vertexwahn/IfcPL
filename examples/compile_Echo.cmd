...
IF EXIST C:\dev\IfcPL\examples\Echo.ifcpl (set IFCPL_SOURCE_FILE=C:\dev\IfcPL\examples\Echo.ifcpl)
IF EXIST E:\dev\IfcPL\examples\Echo.ifcpl (set IFCPL_SOURCE_FILE=E:\dev\IfcPL\examples\Echo.ifcpl)

IF EXIST C:\build\vs2017\x64\tmp\Echo rd /s /q C:\build\vs2017\x64\tmp\Echo
mkdir C:\build\vs2017\x64\tmp\Echo
robocopy %IFCPL_FRAMEWORK% C:\build\vs2017\x64\tmp\Echo
robocopy %IFCPL_FRAMEWORK%\CMake C:\build\vs2017\x64\tmp\Echo\CMake
%TRANSPILER_PATH% %IFCPL_SOURCE_FILE% -o C:\build\vs2017\x64\tmp\Echo
cmake -G"Visual Studio 15 2017 Win64" ^
-HC:\build\vs2017\x64\tmp\Echo ^
-BC:\build\vs2017\x64\tmp\Echo\build ^
...
C:
cd C:\build\vs2017\x64\tmp\Echo\build
