...
IF EXIST C:\dev\IfcPL\examples\HelloWorld.ifcpl (set IFCPL_SOURCE_FILE=C:\dev\IfcPL\examples\HelloWorld.ifcpl)
IF EXIST E:\dev\IfcPL\examples\HelloWorld.ifcpl (set IFCPL_SOURCE_FILE=E:\dev\IfcPL\examples\HelloWorld.ifcpl)

IF EXIST C:\build\vs2017\x64\tmp\HelloWorld rd /s /q C:\build\vs2017\x64\tmp\HelloWorld
mkdir C:\build\vs2017\x64\tmp\HelloWorld
robocopy %IFCPL_FRAMEWORK% C:\build\vs2017\x64\tmp\HelloWorld
robocopy %IFCPL_FRAMEWORK%\CMake C:\build\vs2017\x64\tmp\HelloWorld\CMake
%TRANSPILER_PATH% %IFCPL_SOURCE_FILE% -o C:\build\vs2017\x64\tmp\HelloWorld
cmake -G"Visual Studio 15 2017 Win64" ^
-HC:\build\vs2017\x64\tmp\HelloWorld ^
-BC:\build\vs2017\x64\tmp\HelloWorld\build ^
...
C:
cd C:\build\vs2017\x64\tmp\HelloWorld\build
