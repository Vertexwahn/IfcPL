...
IF EXIST C:\dev\IfcPL\examples\ArrayExample.ifcpl (set IFCPL_SOURCE_FILE=C:\dev\IfcPL\examples\ArrayExample.ifcpl)
IF EXIST E:\dev\IfcPL\examples\ArrayExample.ifcpl (set IFCPL_SOURCE_FILE=E:\dev\IfcPL\examples\ArrayExample.ifcpl)

IF EXIST C:\build\vs2017\x64\tmp\ArrayExample rd /s /q C:\build\vs2017\x64\tmp\ArrayExample
mkdir C:\build\vs2017\x64\tmp\ArrayExample
robocopy %IFCPL_FRAMEWORK% C:\build\vs2017\x64\tmp\ArrayExample
robocopy %IFCPL_FRAMEWORK%\CMake C:\build\vs2017\x64\tmp\ArrayExample\CMake
%TRANSPILER_PATH% %IFCPL_SOURCE_FILE% -o C:\build\vs2017\x64\tmp\ArrayExample
cmake -G"Visual Studio 15 2017 Win64" ^
-HC:\build\vs2017\x64\tmp\ArrayExample ^
-BC:\build\vs2017\x64\tmp\ArrayExample\build ^
...
C:
cd C:\build\vs2017\x64\tmp\ArrayExample\build
